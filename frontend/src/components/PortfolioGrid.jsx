            ...
            >
              {projects.map((project, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`card overflow-hidden shadow-2xl transition-shadow duration-300 bg-gradient-to-b from-primary-100 to-primary-200 dark:from-gray-900 dark:to-gray-900 ${index === currentIndex ? 'ring-2 ring-primary-500 ring-offset-4 dark:ring-offset-gray-900' : ''}`}>
                      {/* Card Header */}
